...
const QUICK_PROMPTS = [
  ...
  { label: 'Rotate Clockwise', instruction: 'rotate it clockwise' },
  { label: 'Rotate Counter-clockwise', instruction: 'rotate it counter-clockwise' },
...
export function PromptAdjuster({
  ...
  const enhancePrompt = (userInstruction: string): string => {
    ...
    // Smart prompt enhancement mapping
    const enhancements: Record<string, string> = {
      bigger: 'increase the logo size by 30%',
      smaller: 'decrease the logo size by 30%',
      'make it bigger': 'increase the logo size by 30%',
      'make it smaller': 'decrease the logo size by 30%',
      left: 'position the logo more towards the left side',
      right: 'position the logo more towards the right side',
      'move it to the left': 'position the logo more towards the left side',
      'move it to the right': 'position the logo more towards the right side',
      'move it higher': 'position the logo higher on the product',
      'move it lower': 'position the logo lower on the product',
      up: 'position the logo higher on the product',
      down: 'position the logo lower on the product',
      ...
      'more prominent': 'make the logo more prominent and eye-catching',
      'more subtle': 'make the logo blend more naturally with the product',
      subtle: 'make the logo blend more naturally with the product',
      prominent: 'make the logo more prominent and eye-catching',
    };
    ...
    // Return original instruction if no enhancement found
