...
import { Zap, Check, ArrowRight, Shield, Clock, RefreshCw, User, Gift, Download } from 'lucide-react';
...
const ConversionZone: React.FC<ConversionZoneProps> = ({ onSignupClick }) => {
  ...
  const [userType, setUserType] = useState<'new' | 'returning' | 'price-sensitive'>('new');
  ...
  const getOfferContent = (): OfferContent => {
    switch (userType) {
      case 'returning':
        return {
          badge: 'Welcome Back!',
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-white/20">
            <div className="text-center">
              ...
              <button
                ...
                className="flex items-center justify-center px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-slate-900 rounded-lg font-bold text-lg hover:from-yellow-300 hover:to-orange-400 transition-all shadow-2xl mx-auto"
              >
                {content?.cta}
        ...
        <div className="hidden" id="exit-intent-trigger">
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full text-slate-900">
              <div className="text-center">
                <Gift size={48} className="mx-auto mb-4 text-blue-600" />
                ...
                <button className="w-full flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors mb-4">
