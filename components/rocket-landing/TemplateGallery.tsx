...
import { Layout, Search, Eye, Download, Heart, Grid3X3, Plus } from 'lucide-react';
...
const TemplateGallery: React.FC<TemplateGalleryProps> = ({ onTemplatePreview }) => {
    ...
    <section id="templates" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="relative aspect-[4/3] bg-gradient-to-br from-slate-100 to-slate-200 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                    <button className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors shadow-lg">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Heart size={16} className="text-slate-300 hover:text-red-500 transition-colors cursor-pointer" />
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center">
          <button className="mr-4 flex items-center px-6 py-3 border border-slate-300 text-slate-700 rounded-lg font-medium hover:bg-slate-50 transition-colors">
