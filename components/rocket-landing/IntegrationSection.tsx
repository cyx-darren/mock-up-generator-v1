...
import { Puzzle, Layers, Check, Star, Download, ExternalLink, Clock, Shield, Play, Link, MousePointer, Smartphone, Zap, ArrowRight, Palette, Users } from 'lucide-react';
...
const IntegrationSection: React.FC = () => {
  const [activeIntegration, setActiveIntegration] = useState<string>('figma');
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      ...
                      <button className="flex items-center px-6 py-3 border border-slate-300 text-slate-700 rounded-lg font-medium hover:bg-slate-50 transition-colors">
                        Learn More
                    ...
                    {integration?.id === 'api' ? (
                      ...
                      <div>
                        ...
                        <div className="mt-6 aspect-video bg-gradient-to-br from-slate-100 to-slate-200 rounded-lg flex items-center justify-center">
                          <div className="text-center">
                            <Play size={32} className="mx-auto mb-2 text-slate-400" />
