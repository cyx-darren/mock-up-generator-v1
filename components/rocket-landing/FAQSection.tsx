...
import { HelpCircle, CreditCard, Settings, FileText, Puzzle, Search, ChevronUp, ChevronDown, RotateCcw, MessageCircle, Mail, MessageSquare, Clock, Zap, BookOpen } from 'lucide-react';
...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    ...
    },
    {
      ...
      answer: `Absolutely. You can cancel your subscription at any time from your account settings. There are no cancellation fees, and you'll continue to have access to your paid features until the end of your billing period.`
    },
    {
      category: 'pricing',
    ...
    {
      category: 'technical',
      question: 'How do the design tool integrations work?',
    ...
    {
      category: 'licensing',
      question: 'Who owns the rights to generated mockups?',
      answer: `You retain full ownership of your original designs. The generated mockups are yours to use according to your plan's license terms. We don't claim any rights to your content or designs.`
    },
    {
      category: 'licensing',
      question: 'Can I remove the watermark from free mockups?',
    ...
    },
    {
      ...
      question: 'Which design tools do you integrate with?',
    ...
    {
      category: 'integrations',
      question: 'How do I install the Figma plugin?',
    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredFAQs?.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 border border-slate-300 text-slate-700 rounded-lg font-medium hover:bg-slate-50 transition-colors mx-auto"
              >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="flex items-center justify-center px-8 py-4 bg-white text-blue-600 rounded-lg font-medium hover:bg-slate-100 transition-colors shadow-lg">
        ...
        <div className="text-center mt-12">
          ...
          <button className="flex items-center px-4 py-2 border border-slate-300 text-slate-700 rounded-lg font-medium hover:bg-slate-50 transition-colors mx-auto">
