        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            {user && (
              <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p>
                    <span className="font-medium">Role:</span> {ROLE_LABELS[user.role]} ({user.role}
                    )
                  </p>
                  <p>
                    <span className="font-medium">Description:</span> {ROLE_DESCRIPTIONS[user.role]}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="text-sm space-y-1">
                  <p>
                    Can view products:{' '}
                    <span className={can('canViewProducts') ? 'text-green-600' : 'text-red-600'}>
                      {can('canViewProducts') ? '✓' : '✗'}
                    </span>
                  </p>
                  <p>
                    Can create products:{' '}
                    <span className={can('canCreateProducts') ? 'text-green-600' : 'text-red-600'}>
                      {can('canCreateProducts') ? '✓' : '✗'}
                    </span>
                  </p>
                  <p>
                    Can edit products:{' '}
                    <span className={can('canEditProducts') ? 'text-green-600' : 'text-red-600'}>
                      {can('canEditProducts') ? '✓' : '✗'}
                    </span>
                  </p>
                  <p>
                    Can delete products:{' '}
                    <span className={can('canDeleteProducts') ? 'text-green-600' : 'text-red-600'}>
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm space-y-1">
                  <p>
                    Can view users:{' '}
                    <span className={can('canViewUsers') ? 'text-green-600' : 'text-red-600'}>
                      {can('canViewUsers') ? '✓' : '✗'}
                    </span>
                  </p>
                  <p>
                    Can create users:{' '}
                    <span className={can('canCreateUsers') ? 'text-green-600' : 'text-red-600'}>
                      {can('canCreateUsers') ? '✓' : '✗'}
                    </span>
                  </p>
                  <p>
                    Can view analytics:{' '}
                    <span className={can('canViewAnalytics') ? 'text-green-600' : 'text-red-600'}>
                  ...
                  <p>
                    Can access settings:{' '}
                    <span
                      className={can('canAccessSystemSettings') ? 'text-green-600' : 'text-red-600'}
                    >
                      {can('canAccessSystemSettings') ? '✓' : '✗'}
                    </span>
                  </p>
                </div>
              </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              <RequireRole
                role="super_admin"
                fallback={<div className="text-gray-500 italic">Super admin content hidden</div>}
              >
              ...
              <RequireAnyRole
                ...
                fallback={
                  <div className="text-gray-500 italic">Product management content hidden</div>
                }
              >
                <div className="bg-green-50 border border-green-200 rounded-md p-3">
                  <h4 className="font-medium text-green-900">Product Management Content</h4>
                  <p className="text-sm text-green-700">
                    This content is visible to product managers and super admins.
                  </p>
                </div>
              </RequireAnyRole>
              ...
              <RequirePermission
                ...
                fallback={<div className="text-gray-500 italic">Analytics content hidden</div>}
              >
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                  <h4 className="font-medium text-blue-900">Analytics Content</h4>
                  <p className="text-sm text-blue-700">
                    This content requires analytics viewing permission.
                  </p>
                </div>
              </RequirePermission>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  onClick={() =>
                    testAPIEndpoint('POST', '/api/admin/test-permissions', {
                      action: 'test_super_admin',
                    })
                  }
                  disabled={isLoading}
                  size="sm"
                ...
                <Button
                  onClick={() =>
                    testAPIEndpoint('PUT', '/api/admin/test-permissions', {
                      action: 'test_product_manager',
                    })
                  }
                  disabled={isLoading}
                  size="sm"
