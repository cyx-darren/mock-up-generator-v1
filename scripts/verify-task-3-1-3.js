async function verifyTask313() {
  ...
  try {
    ...
    console.log(
      `Dimension Settings: ${testResults.dimensionSettings.passed}/${products.length} passed`
    );
    console.log(
      `Default Positions: ${testResults.defaultPositions.passed}/${products.length} passed`
    );
    console.log(
      `Constraints Enabled: ${testResults.constraintsEnabled.passed}/${products.length} passed`
    );
