...
export class PreviewSystem {
  ...
  generateZoomedPreview(
    ...
    this.ctx.translate(
      this.zoomState.offsetX / this.zoomState.scale,
      this.zoomState.offsetY / this.zoomState.scale
    );
    ...
    this.ctx.fillRect(
      -this.zoomState.offsetX / this.zoomState.scale,
      -this.zoomState.offsetY / this.zoomState.scale,
      opts.width / this.zoomState.scale,
      opts.height / this.zoomState.scale
    );
  ...
  private drawTransparencyChecker(
    width: number,
    height: number,
    size: number,
