...
const PricingSection = ({ onSignupClick }) => {
  ...
  const plans = [
    ...
    },
    {
      ...
      popular: true,
      color: 'blue',
      savings: billingCycle === 'annual' ? '17%' : null
    },
    {
      id: 'enterprise',
      name: 'Enterprise',
      ...
      popular: false,
      color: 'purple',
      savings: billingCycle === 'annual' ? '20%' : null
    }
  ];
            ...
            >
              ...
              <div className="p-8">
                  ...
                  {plan?.limitations?.length > 0 && (
                    <div className="pt-4 border-t border-slate-200">
                      ...
                      {plan?.limitations?.map((limitation, index) => (
                        <div key={index} className="flex items-start space-x-3">
                          <Icon name="X" size={16} className="text-slate-400 flex-shrink-0 mt-0.5" />
                ...
                <Button
                  ...
                  className={`${plan?.popular ? 'shadow-cta' : ''}`}
